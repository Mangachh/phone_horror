...
namespace MySystems
{
    ...
    /// </remarks>
    /// </summary>
    public class DummyVisualSystem : VisualSystem_Base
    {
        ...
        /// </summary>
        public DummyVisualSystem(in SystemManager manager) : base(null, manager)
        {
        ...
        {
            //Console.ExitStack(this);
            //Console.Print("The Dummy system is suposed to be allways into the stack!!!", Console.MessageType.ERROR);            
        }
        ...
        public override void MyUpdate(in float delta)
        {
            ...
            {
                //Console.Print(MESSAGE, Console.MessageType.ERROR);
                this.SetTimer();
            }
            base.MyUpdate(delta);
